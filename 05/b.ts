...
// I asked chatGPT to create a stack for me and then decided I actually wanted
// a queue so I added pushBack.
class Stack {
    ...
    // The pushBack() method adds an element to the bottom of the stack
    pushBack(item: any) {
