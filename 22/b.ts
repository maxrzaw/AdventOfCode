...
function GetFacingValue(facing: Facing): number {
    assert(facing !== Facing.None, "GetFacingValue called with None");
    switch (facing) {
        case Facing.Right:
            return 0;
        case Facing.Down:
...
function GetFacingDelta(facing: Facing): number[] {
    assert(facing !== Facing.None, "GetFacingDelta called with None");
    switch (facing) {
        case Facing.Right:
            return [0, 1];
        case Facing.Down:
...
function GetFacingString(facing: Facing): string {
    assert(facing !== Facing.None, "GetFacingString called with None");
    switch (facing) {
        case Facing.Right:
            return '>';
        case Facing.Down:
...
function MoveForward(board: Tile[][], row: number, col: number, currentDirection: Facing, distance: number): { row: number, col: number, facing: Facing } {
    ...
    while (distance > 0) {
        ...
        assert(currentDirection !== Facing.None, `Facing: ${currentDirection.toString()}`);
        ...
        if (newRow > board.length - 1 || newRow < 0
            ...
            newRow = wrapped.row;
            newCol = wrapped.col;
            assert(currentDirection !== Facing.None, `Facing after going off the edge: ${currentDirection.toString()}, curent face: ${GetFace(row, col).toString()}, current location: [${row}, ${col}]\n`);
        }
    ...
    assert(lastConfirmed.facing !== Facing.None);
...
log(`password = 1000 * ${(row + 1)} + 4 * ${(col + 1)} + ${GetFacingValue(currentDirection)} `);
log(password);
        ...
        case 1:
            switch (facing) {
                ...
                case Facing.Left:
                    ...
                    break;
                default:
                    assert(false, `impossible direction from face 1, facing: ${facing} `);
            }
            break;
        case 2:
            switch (facing) {
                ...
                case Facing.Up:
                    ...
                    break;
                default:
                    assert(false, "impossible direction from face 2");
            }
            break;
        case 3:
            switch (facing) {
                ...
                case Facing.Right:
                    ...
                    break;
                default:
                    assert(false, "impossible direction from face 3");
            }
            break;
        case 4:
            switch (facing) {
                ...
                case Facing.Up:
                    ...
                    break;
                default:
                    assert(false, "impossible direction from face 4");
            }
            break;
        case 5:
            switch (facing) {
                ...
                case Facing.Down:
                    ...
                    break;
                default:
                    assert(false, "impossible direction from face 5");
            }
            break;
        case 6:
            switch (facing) {
                ...
                case Facing.Left:
                    ...
                    break;
                default:
                    assert(false, "impossible direction from face 6");
            }
            break;
    }

    assert(newDirection !== Facing.None, "newDirection was None at the end of Wrap");
